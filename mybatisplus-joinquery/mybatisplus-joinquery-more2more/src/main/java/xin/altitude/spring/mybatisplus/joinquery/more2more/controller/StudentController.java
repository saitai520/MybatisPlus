...
package xin.altitude.spring.mybatisplus.joinquery.more2more.controller;
...
public class StudentController {
    ...
    public AjaxResult detail(@PathVariable("stuId") Integer id) {
    ...
    public AjaxResult page() {
        return AjaxResult.success(studentService.getStudentPage(new Page<>()));
    }
}
