...
INSERT INTO `tb_user` VALUES (1,'Jone',1,'ab@c.c',10,_binary '\0',NULL,'2021-05-24 15:12:01'),(2,'Jack',3,'test2@baomidou.com',11,_binary '\0',NULL,'2021-05-24 15:12:04'),(3,'Billie',2,'test5@baomidou.com',12,_binary '\0',NULL,'2021-10-21 10:51:24'),(4,'didi',12,'test@qq.com',12,_binary '\0','2021-06-05 19:22:46','2021-10-21 14:38:26');
...
/*!50001 VIEW `user_dept_view` AS select `a`.`user_id` AS `user_id`,`a`.`user_name` AS `user_name`,`a`.`age` AS `age`,`a`.`email` AS `email`,`b`.`dept_id` AS `dept_id`,`b`.`dept_name` AS `dept_name`,`b`.`staff` AS `staff`,`b`.`tel` AS `tel` from (`tb_user` `a` left join `tb_dept` `b` on((`a`.`dept_id` = `b`.`dept_id`))) */;
...
-- Dump completed on 2022-11-04 18:20:16
